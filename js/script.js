...
let modal = function(modalClick){
    modalView[modalClick].classList.add('active_modal')
}
...
function scrollHeader(){
    ...
    // When the scrollY is greater than 200 vh add scroll-header class
    if(this.scrollY >= 80){
...
function scrollUp(){
    ...
    // When the scrollY is greater than 560 vh add scroll-header class
    if(this.scrollY >= 560){
